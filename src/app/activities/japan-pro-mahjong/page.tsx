        ...
        <div className="min-h-screen bg-slate-50 flex flex-col font-sans">
            ...
            <main className="flex-grow py-12 px-4 sm:px-6 lg:px-8 mt-16">
                <div className="max-w-4xl mx-auto">
                    ...
                    <Link
                        href="/#activity"
                        className="group inline-flex items-center gap-2 text-sm font-semibold text-slate-600 bg-white hover:bg-slate-50 border border-slate-200 px-4 py-2 rounded-full mb-8 transition-all hover:shadow-sm hover:border-slate-300"
                    >
                    ...
                    <div className="bg-white rounded-3xl p-8 sm:p-12 shadow-sm border border-slate-100 mb-8 relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-lg text-slate-600 leading-relaxed mb-6">
                                ...
                                協会広島プロアマシリーズの運営を通じて、プロとアマチュアが真剣勝負できる場を提供しています。
                            </p>
                            <a
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                        ...
                        <div className="bg-white rounded-3xl p-8 shadow-sm border border-slate-100">
                            ...
                            <div className="prose prose-slate max-w-none">
                                <p className="mb-4">
                                    広島エリアにおける麻雀の競技水準向上と交流を目的として、<strong>協会広島プロアマシリーズ</strong>を中心としたプロアマシリーズを運営しています。
                                </p>
                                <p>
